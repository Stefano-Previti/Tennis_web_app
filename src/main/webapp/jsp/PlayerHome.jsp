...
.image-box.view-tournament {
    background-image: url('/tenniswebapp/image/partita.jpg');
}
                ...
                <div class="user-data-block">
                    <p>Nome Torneo: <%=session.getAttribute("Nome torneo") %></p>
                          <form action="<%=JView.Search1CTL%>" method="post">
                            <label for="newPunti"></label>
                        <input type="text" id="newPunti" name="newPunti" placeholder="<%= session.getAttribute("Punti") %>" style="width: 80px; height:35px;">
                        <input type="submit" value="Aggiorna punti" class="submit-button" style="width:130px;;">
    ...
    <div class="container images-column">
        <div class="image-box view-tournament">
            <div class="image-button">
                 <a href="<%=JView.VisualizzazioneTorneoCTL %>" class="button">Visualizza torneo</a>
            </div>
        </div>

        <div class="image-box manage"> 
            <div class="image-button">
                 <a href="<%=JView.GestioneNoleggioCTL %>" class="button">Gestione noleggio torneo</a>
            </div>
        </div>

        <div class="image-box view-equipment"> 
            <div class="image-button">
                 <a href="<%=JView.VisualizzaNoleggioCTL %>" class="button">Visualizza noleggio torneo</a>
            </div>
        </div>
    </div>
</body>
